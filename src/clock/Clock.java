...
public class Clock extends Application{
	...
	private AppState appState = AppState.CLOCK;
	static private KeyFrame frame;
	...
	public void start(Stage stage) throws Exception{
		...
		//setting up KeyFrame
		/*if(appState.equals(AppState.CLOCK)) {
	...
	private Button initButtonFramework(String text, Text textDisplay, EventHandler<ActionEvent> onFinished, long duration, AppState localAppState) {
		...
		NodeLoader nodeLoader = new FrameDisplay(textDisplay,timeline);
	...
	private void initPauseButton() {
		pauseButton = new Button("Pause/Play");
